...
def get_recipe_ingredient_usage(chart_type, recipe_id):
   ...
   #select chart_type based on user input from the form
    if chart_type == '#1':
       ...
       plt.bar(ingredients, recipe_counts, color='#cce2b5')
       ...
       colors = ['#cce2b5','#e2c3dc','#dbdce2','#ba93b2', '#ecadcb']
       plt.figure(figsize=(6,6))
       plt.pie(recipe_counts, labels=ingredients, autopct='%1.1f%%', colors=colors)
       ...
       plt.plot(ingredients, recipe_counts, color='#cce2b5')
       plt.title("Number of Recipes Containing Each Ingredient")
       plt.xlabel('Ingredients')
       plt.ylabel('Number of Recipes')
